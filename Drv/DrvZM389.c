...
#define DrvMC8332_UART_NoMAX    6	//如果出现出具偶尔接收不到，增大此值，可以解决问题
#define DrvMC8332Poc_UART_NoMAX 9	//define UART Tx buffer length value
...
void DrvZM389_uart1_interrupt(void)
{
